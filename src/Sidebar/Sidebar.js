            ...
            <Container>
                <Content>
                    ...
                    <Picker
                        ...
                        >
                        <Item label="Naveen Kumar" value="@NaveenKumar" />
                        <Item label="Praveen Kumar" value="@PraveenKumar" />
                        <Item label="Dinesh Kumar" value="@DineshKumar" />
                        <Item label="Pradeep" value="@Pradeep" />
                        <Item label="Vignesh" value="@Vignesh" />
                    </Picker>
                    <List>
                        <ListItem noBorder> 
                            <Text
                ...
                <Footer transparent>
                    <FooterTab>
                        ...
                        <Icon.Button name="qrcode" transparent>
                        </Icon.Button>
